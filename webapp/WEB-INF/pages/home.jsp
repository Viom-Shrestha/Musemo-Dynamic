...
<body>
	...
	<div class="hero"
		style="background-image: url('${contextPath}/resources/images/home_hero.jpg');">
	...
	<div class="plan-section">
		...
		<div class="map-img">
			<img src="${contextPath}/resources/images/system/plan.jpg"
				alt="Museum Map">
		</div>
	</div>
	...
	<div class="stats-container">
		<div class="stat-card">
			<div class="stat-img">
				<img src="${contextPath}/resources/images/icons/artifacts_icon.png"
					alt="Artifacts Icon">
			</div>
		...
		<div class="stat-card">
			<div class="stat-img">
				<img src="${contextPath}/resources/images/icons/visitor_icon.png"
					alt="Visitor Icon">
			</div>
			<div class="stat-content">
		...
		<div class="stat-card">
			<div class="stat-img">
				<img src="${contextPath}/resources/images/icons/bookings_icon.png"
					alt="Bookings Icon">
			</div>
			<div class="stat-content">
